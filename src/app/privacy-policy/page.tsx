...
import NavBarPolicy from "@/app/components/NavBarPolicy";
  ...
  return (
    <section className={`${styles["policy-text"]}`}>
      ...
      >
        ...
        <NavBarPolicy>
          <PolicyTab label="1. Общие положения">
            <h2 className={`${styles["policy-title"]}`}>1. Общие положения</h2>
            <p className={`${styles["policy-text"]}`}>
              ...
              ООО "Агентство Коммуникаций "Макстер" (далее — Оператор).
            </p>
            <p>
          ...
          <PolicyTab label="3. Основные права и обязанности Оператора">
          ...
          <PolicyTab label="4. Основные права и обязанности субъектов персональных данных">
          ...
          <PolicyTab label="5. Принципы обработки персональных данных">
          ...
          <PolicyTab label="6. Цели обработки персональных данных">
          ...
          <PolicyTab label="7. Условия обработки персональных данных">
          ...
          <PolicyTab
            label="8. Порядок сбора, хранения, передачи и других видов обработки
              персональных данных"
          >
            <h3 className={`${styles["policy-title"]}`}>
          ...
          <PolicyTab
            label="9. Перечень действий, производимых Оператором с полученными
          ...
          <PolicyTab label="10. Трансграничная передача персональных данных">
            <h5 className={`${styles["policy-title"]}`}>
          ...
          <PolicyTab label="11. Конфиденциальность персональных данных">
            <h6 className={`${styles["policy-title"]}`}>
          ...
          <PolicyTab label="12. Заключительные положения">
            <h1 className={`${styles["policy-title"]}`}>
