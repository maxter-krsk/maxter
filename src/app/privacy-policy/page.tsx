    ...
    <section>
      ...
      >
        ...
        <p>
          ...
          безопасности персональных данных, предпринимаемые ООО "Агентство
          Коммуникаций "Макстер" (далее — Оператор).
        </p>
        <p>
        ...
        <h6>5. Принципы обработки персональных данных</h6>
        <p>
        ...
        <h6>11. Конфиденциальность персональных данных</h6>
        <p>
